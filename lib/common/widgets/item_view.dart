...
import 'package:apna_demand/features/home/widgets/web/widgets/store_card_widget.dart';
...
import 'package:apna_demand/common/widgets/item_shimmer.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      !isNull ? length > 0 ? GridView.builder(
        key: ValueKey(isNull ? 'shimmer' : (widget.isStore ? 'stores' : 'items')),
