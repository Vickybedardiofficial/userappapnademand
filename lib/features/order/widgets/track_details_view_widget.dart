...
import 'package:apna_demand/common/widgets/custom_divider.dart';
...
import 'package:apna_demand/features/order/widgets/address_details_widget.dart';
...
class TrackDetailsViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool isWideLayout = MediaQuery.sizeOf(context).width >= 1300;
    double distance = 0;
      ...
      child: (!takeAway && track.deliveryMan == null) ? Padding(
        ...
        Row(children: [
          ...
          showChatPermission ? InkWell(
            ...
            child: Container(
              padding: EdgeInsets.symmetric(vertical: isWideLayout ? 7 : Dimensions.paddingSizeExtraSmall, horizontal: Dimensions.paddingSizeSmall),
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                color: Colors.green,
              ),
