  ...
  Widget build(BuildContext context) {
    return AnimatedScale(
      ...
      child: CachedNetworkImage(
        ...
        memCacheHeight: !kIsWeb && height != null ? (height! * MediaQuery.of(context).devicePixelRatio).toInt() : null,
        memCacheWidth: !kIsWeb && width != null ? (width! * MediaQuery.of(context).devicePixelRatio).toInt() : null,
