...
import 'package:apna_demand/features/location/widgets/permission_dialog_widget.dart';
...
class LocationService implements LocationServiceInterface{
  ...
  Future<List<PredictionModel>> searchLocation(String text) async {
    ...
    if (response.statusCode == 200) {
      ...
      showCustomSnackBar(response.body != null ? response.body['error_message'] ?? response.statusText : response.statusText);
    }
