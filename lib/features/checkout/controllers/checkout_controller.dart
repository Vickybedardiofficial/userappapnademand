...
import 'package:apna_demand/api/api_checker.dart';
import 'package:apna_demand/features/cart/controllers/cart_controller.dart';
import 'package:apna_demand/features/checkout/domain/models/payment_model.dart';
import 'package:apna_demand/features/checkout/domain/models/surge_price_model.dart';
...
import 'package:apna_demand/features/payment/domain/models/offline_method_model.dart';
import 'package:apna_demand/features/checkout/domain/models/place_order_body_model.dart';
import 'package:apna_demand/features/checkout/domain/models/timeslote_model.dart';
import 'package:apna_demand/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:apna_demand/features/checkout/widgets/order_successfull_dialog.dart';
import 'package:apna_demand/features/checkout/widgets/partial_pay_dialog_widget.dart';
...
class CheckoutController extends GetxController implements GetxService {
  ...
  Future<void> insertAddresses(AddressModel? addressModel, {bool notify = false}) async {
    ...
    debugPrint('======addressModel: ${addressModel?.toJson()}');
    ...
    if(AuthHelper.isLoggedIn()) {
      ...
      debugPrint('======addressModel 2 : ${addressModel?.toJson()}');
    }
    ...
    debugPrint('======addressModel 3: ${addressModel?.toJson()}');
    if(notify) update();
  }
