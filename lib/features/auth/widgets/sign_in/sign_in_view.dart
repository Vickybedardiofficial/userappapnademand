...
import 'package:apna_demand/features/auth/widgets/sign_in/manual_login_widget.dart';
import 'package:apna_demand/features/auth/widgets/sign_in/otp_login_widget.dart';
...
import 'package:apna_demand/helper/centralize_login_helper.dart';
    ...
    return GetBuilder<AuthController>(builder: (authController) {
      ...
      return Form(
        ...
        child: OtpLoginWidget(
          ...
          onClickLoginButton: () {
            _otpLogin(Get.find<AuthController>(), _countryDialCode ?? Get.find<LocalizationController>().locale.countryCode!, CentralizeLoginType.otp);
          },
          socialEnable: Get.find<SplashController>().configModel?.centralizeLoginSetup?.socialLoginStatus ?? true,
        ),
      );
    });
  }
