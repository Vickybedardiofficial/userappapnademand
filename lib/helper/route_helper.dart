...
import 'package:apna_demand/common/widgets/zone_warning_dialog.dart';
...
import 'package:apna_demand/features/auth/screens/rider_registration_screen.dart';
import 'package:apna_demand/features/brands/screens/brands_product_screen.dart';
import 'package:apna_demand/features/brands/screens/brands_screen.dart';
import 'package:apna_demand/features/business/screens/subscription_payment_screen.dart';
import 'package:apna_demand/features/business/screens/subscription_success_or_failed_screen.dart';
import 'package:apna_demand/features/chat/domain/models/order_chat_model.dart';
import 'package:apna_demand/features/checkout/screens/digital_payment_failed_screen.dart';
import 'package:apna_demand/features/home/screens/home_screen.dart';
import 'package:apna_demand/features/item/screens/item_view_all_screen.dart';
import 'package:apna_demand/features/language/controllers/language_controller.dart';
import 'package:apna_demand/features/loyalty/screens/loyalty_screen.dart';
import 'package:apna_demand/features/profile/domain/models/update_user_model.dart';
import 'package:apna_demand/features/profile/screens/setting_page.dart';
import 'package:apna_demand/features/refer_and_earn/screens/refer_and_earn_screen.dart';
...
import 'package:apna_demand/features/item/domain/models/basic_campaign_model.dart';
import 'package:apna_demand/features/chat/domain/models/conversation_model.dart';
import 'package:apna_demand/features/order/domain/models/order_model.dart';
import 'package:apna_demand/features/item/domain/models/item_model.dart';
import 'package:apna_demand/features/parcel/domain/models/parcel_category_model.dart';
import 'package:apna_demand/features/store/domain/models/store_model.dart';
import 'package:apna_demand/features/address/screens/add_address_screen.dart';
import 'package:apna_demand/features/address/screens/address_screen.dart';
import 'package:apna_demand/features/auth/screens/delivery_man_registration_screen.dart';
import 'package:apna_demand/features/auth/screens/sign_in_screen.dart';
import 'package:apna_demand/features/auth/screens/sign_up_screen.dart';
import 'package:apna_demand/features/auth/screens/store_registration_screen.dart';
import 'package:apna_demand/features/category/screens/category_screen.dart';
import 'package:apna_demand/features/location/screens/map_screen.dart';
import 'package:apna_demand/features/store/screens/campaign_screen.dart';
import 'package:apna_demand/features/store/widgets/all_store_web_view_widget.dart';
import 'package:apna_demand/helper/address_helper.dart';
import 'package:apna_demand/helper/auth_helper.dart';
import 'package:apna_demand/helper/module_helper.dart';
import 'package:apna_demand/api/api_client.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:apna_demand/helper/shallow_route_helper.dart';
import 'package:apna_demand/util/app_constants.dart';
import 'package:apna_demand/util/html_type.dart';
import 'package:apna_demand/common/widgets/custom_loader.dart';
import 'package:apna_demand/common/widgets/image_viewer_screen.dart';
import 'package:apna_demand/common/widgets/not_found.dart';
import 'package:apna_demand/features/cart/screens/cart_screen.dart';
import 'package:apna_demand/features/category/screens/category_item_screen.dart';
import 'package:apna_demand/features/chat/screens/chat_screen.dart';
import 'package:apna_demand/features/chat/screens/conversation_screen.dart';
import 'package:apna_demand/features/checkout/screens/checkout_screen.dart';
import 'package:apna_demand/features/payment/screens/offline_payment_screen.dart';
import 'package:apna_demand/features/checkout/screens/order_successful_screen.dart';
import 'package:apna_demand/features/payment/screens/payment_screen.dart';
import 'package:apna_demand/features/payment/screens/payment_webview_screen.dart';
import 'package:apna_demand/features/coupon/screens/coupon_screen.dart';
import 'package:apna_demand/features/dashboard/screens/dashboard_screen.dart';
import 'package:apna_demand/features/favourite/screens/favourite_screen.dart';
import 'package:apna_demand/features/flash_sale/screens/flash_sale_details_screen.dart';
import 'package:apna_demand/features/item/screens/item_campaign_screen.dart';
import 'package:apna_demand/features/item/screens/item_details_screen.dart';
import 'package:apna_demand/features/item/screens/popular_item_screen.dart';
import 'package:apna_demand/features/verification/screens/forget_pass_screen.dart';
import 'package:apna_demand/features/verification/screens/new_pass_screen.dart';
import 'package:apna_demand/features/verification/screens/verification_screen.dart';
import 'package:apna_demand/features/html/screens/html_viewer_screen.dart';
import 'package:apna_demand/features/interest/screens/interest_screen.dart';
import 'package:apna_demand/features/language/screens/language_screen.dart';
import 'package:apna_demand/features/location/screens/access_location_screen.dart';
import 'package:apna_demand/features/location/screens/pick_map_screen.dart';
import 'package:apna_demand/features/notification/screens/notification_screen.dart';
import 'package:apna_demand/features/onboard/screens/onboarding_screen.dart';
import 'package:apna_demand/features/order/screens/guest_track_order_screen.dart';
import 'package:apna_demand/features/order/screens/order_details_screen.dart';
import 'package:apna_demand/features/order/screens/order_screen.dart';
import 'package:apna_demand/features/order/screens/order_tracking_screen.dart';
import 'package:apna_demand/features/order/screens/refund_request_screen.dart';
import 'package:apna_demand/features/parcel/screens/parcel_category_screen.dart';
import 'package:apna_demand/features/parcel/screens/parcel_location_screen.dart';
import 'package:apna_demand/features/parcel/screens/parcel_request_screen.dart';
import 'package:apna_demand/features/profile/screens/profile_screen.dart';
import 'package:apna_demand/features/profile/screens/update_profile_screen.dart';
import 'package:apna_demand/features/store/screens/all_store_screen.dart';
import 'package:apna_demand/features/store/screens/store_item_search_screen.dart';
import 'package:apna_demand/features/store/screens/store_screen.dart';
import 'package:apna_demand/features/review/screens/review_screen.dart';
import 'package:apna_demand/features/search/screens/search_screen.dart';
import 'package:apna_demand/features/splash/screens/splash_screen.dart';
import 'package:apna_demand/features/support/screens/support_screen.dart';
import 'package:apna_demand/features/update/screens/update_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:apna_demand/features/wallet/screens/wallet_screen.dart';
import 'package:apna_demand/features/ride_share_module/safety_alert/screens/safety_policy_screen.dart';
...
class RouteHelper {
  ...
  static String getSplashRoute(NotificationBodyModel? body, String? deeplink) {
    ...
    debugPrint('=======splash screen calling-------------: $splash?data=$data&deeplink=$deeplink');
  ...
  static List<GetPage> routes = [
    GetPage(name: initial, page: () {
      debugPrint('=======route: ${Get.parameters['module']} // ${Get.parameters['module'] != null && Get.parameters['module']!.isNotEmpty && Get.parameters['module'] != 'null'}');
      return getRoute(
    ...
    GetPage(name: splash, page: () {
      ...
      debugPrint('-------going to splash screen======2');
  ...
  static Widget getRoute(Widget navigateTo, {AccessLocationScreen? locationScreen, bool byPuss = false}) {
    ...
    return (AppConstants.appVersion < minimumVersion! && !GetPlatform.isWeb) ? const UpdateScreen(isUpdate: true)
        : splashController.configModel!.maintenanceMode! ? const UpdateScreen(isUpdate: false)
  ...
  static Widget _waitForModule(String? moduleId, Widget child, {bool fromDeeplink = false}) {
    if(moduleId != null && moduleId.isNotEmpty && moduleId != 'null') {
      debugPrint('=======wait for module: $moduleId');
      return FutureBuilder(
        future: checkModuleId(moduleId, fromDeeplink: fromDeeplink),
        builder: (context, snapshot) {
          debugPrint('-------module future builder: ${snapshot.connectionState} // has data: ${snapshot.hasData} // error: ${snapshot.hasError}');
  ...
  static Future<void> checkModuleId(String? parameters, {bool fromDeeplink = false}) async {
    try {
      if(parameters != null && parameters.isNotEmpty && parameters != 'null') {
        ...
        debugPrint('-----111-----config model is null: ${Get.find<SplashController>().configModel == null} // address: $addressModel // $fromDeeplink');

        if(addressModel != null) {
          debugPrint('-------address is not null, proceeding----');
          if(!fromDeeplink && !GetPlatform.isWeb) {
            debugPrint('-------from deeplink, not executing function');
            return;
          }
          ...
          debugPrint('-----222-----module fetch status: $v');
          if(v) {
            if(Get.find<SplashController>().moduleList != null) {
              ...
              for (ModuleModel module in Get.find<SplashController>().moduleList!) {
                debugPrint('-------module slug: ${module.slug} == $moduleSlug');
              ...
              if(!AuthHelper.isLoggedIn() && !AuthHelper.isGuestLoggedIn()) {
                debugPrint('-------doing guest login > 1');
              ...
              debugPrint('-------found module: ${foundModule?.slug ?? foundModule?.id} // can route : $canContinue');
              if(foundModule != null) {
      ...
      debugPrint('=======checkModuleId error: $e');
      await Get.find<SplashController>().setModule(null);
      ShallowRouterHelper.updateParameter('module', 'null');
      Get.offAllNamed(getInitialRoute(moduleId: 'null'));
    }
...
Future<void> _moduleCheck(String moduleSlug, ApiClient apiClient, SharedPreferences sharedPreferences, AddressModel addressModel) async {
  try {
    ...
    debugPrint('----------config model is null: ${Get.find<SplashController>().configModel == null}');
    if(Get.find<SplashController>().configModel == null) {
      debugPrint('======config data call from route Helper');
    }

    debugPrint('=======module fetching----');
    bool v = await Get.find<SplashController>().getModules(dataSource: DataSourceEnum.client);
    debugPrint('=======module fetch status: $v');
    if(v) {
      if(Get.find<SplashController>().moduleList != null) {
        ModuleModel? foundModule;
        for (ModuleModel module in Get.find<SplashController>().moduleList!) {
        ...
        debugPrint('-------found module: ${foundModule?.slug ?? foundModule?.id} // route module slug: $moduleSlug');
        if(foundModule != null) {
          Get.find<SplashController>().setModule(foundModule);
          apiClient.updateHeader(
    ...
    debugPrint('=======module check error: $e');
    await Get.find<SplashController>().setModule(null);
    Get.offAllNamed(RouteHelper.getInitialRoute(moduleId: 'null'));
  }
