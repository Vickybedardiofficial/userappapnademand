...
class CookiesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String cookiesText = splashController.configModel?.cookiesText ?? 'This is dummy cookies text';
        ...
        child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            ...
            TextButton(
              ...
              onPressed: (){
                splashController.saveCookiesData(false);
              }, child:  Text(
              'no_thanks'.tr,
            ...
            TextButton(
              ...
              onPressed: (){
                splashController.saveCookiesData(true);
                splashController.cookiesStatusChange(cookiesText);
              },
